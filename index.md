...
I'm a second-year PhD student working on Machine Learning (ML) at EuroMov Digital Health in Motion (Univ. Montpellier, IMT Mines Alès). I'm particularly interested in understanding how we can create predictive models which are abble to support decision-makers, especially in sensitive fields such as the ones we work on at EuroMov DHM (health, sports medicine, etc.). Indeed, in these sensitive areas, any inaccurate algorithm can lead to potential adverse consequences. Thus, ML algorithms should incorporate methods capable of providing information about their quality. This would allow decision-makers and experts to gauge the level of confidence they can place in the ML’s predictions. To do so, my research focuses on uncertainty quantification in ML. During the first year of my PhD, I focused in particular on conformal prediction in the context of time series. On the application side, for now, I have mainly worked with GPS and heart rate data for different use cases. Looking ahead, an option is to explore Return-to-Play applications, depending on data availability.


## News
- Our extended abstract has been accepted at MOCO 26. I will be in Montpellier (23-25 April) to talk about it.
- I'm happy to have visited Isaac Martin de Diego at [DSLAB, Universidad Rey Juan Carlos](https://www.datasciencelab.es/) from september to december 2025. Thanks for the host ! This visit was possible thanks to [EULiST](https://eulist.university/).
- Our project about cautious neural networks has been selected by the collège doctoral of Montpellier for the funding of a 6-month internship during the 2026 academic year.
- The [proceedings](https://link.springer.com/book/9783032167071#affiliations) of the ECAI workshop will be published on 17 april 2026.
- On October 25th 2025, I talked about our paper *Relevance-Aware Thresholding in Online Conformal Prediction for Time Series* at the International Joint Workshop of Artificial Intelligence for Healthcare and HYbrid Models for Coupling Deductive and Inductive ReAsoning (ECAI 2025) in Bologna.
